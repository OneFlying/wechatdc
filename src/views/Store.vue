  ...
  <div style="overflow: hidden">
    <div>
      ...
      <div v-show="demo2 === '商品'">
        ...
        <div class="content">
          <scroller lock-x scrollbar-y height="-150+'px'" v-ref:scroller @on-scroll="onscroll" prevent-default="true">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      remove (good, sort) {
        // 移除购物车
        if (this.list[sort].foods[good].number <= 0) return
