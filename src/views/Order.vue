...
<template>
  <div>
    ...
    <div v-show="demo2 === '待取餐'">
      <scroller
        lock-x scrollbar-y use-pullup use-pulldown v-ref:scrollerleft height="-140+'px'"
        @pullup:loading="loadmore"
        @pulldown:loading="refresh"
        :pullup-status.sync="pullupStatus"
        :pulldown-config="pulldownConfig">
        <div style="padding-bottom: 10px" class="box2">
    ...
    <div v-else>
      <scroller
        lock-x scrollbar-y use-pullup use-pulldown v-ref:scrolleright height="-140+'px'"
            ...
            <a class="weui_media_box weui_media_appmsg"
              ...
              <div class="weui_media_bd">
                ...
                <p class="weui_media_desc">
                  ...
                  <cell class="wxdc_weui_media_title" v-if="i % 2 === 0 && i % 4 !== 0">
                        <span slot="value">
                          <x-button mini class="wxdc-btn" @click.stop.prevent="qucan">去取餐</x-button>
                        </span>
                    <span slot="value">
                  ...
                  <cell class="wxdc_weui_media_title" v-if="i % 2 === 0 && i% 4 === 0">
                        <span slot="value">
                          <x-button mini class="wxdc-btn" @click.stop.prevent="qucan">去支付</x-button>
                        </span>
                    <span slot="value">
                          <x-button mini class="wxdc-btn" @click.stop.prevent="onemore">再来一单</x-button>
                        </span>
                  </cell>
                  <cell class="wxdc_weui_media_title" v-if="i % 2 !== 0 && i % 3 !== 0">
                        <span slot="value">
                          <x-button mini class="wxdc-btn" @click.stop.prevent="commit">评价</x-button>
                        </span>
                    <span slot="value">
                          <x-button mini class="wxdc-btn" @click.stop.prevent="onemore">再来一单</x-button>
                        </span>
                  ...
                  <cell class="wxdc_weui_media_title" v-if="i % 2 !== 0 && i % 3 === 0">
                        <span slot="value">
                          <x-button mini class="wxdc-btn" @click.stop.prevent="warn">投诉</x-button>
                        </span>
                    <span slot="value">
                          <x-button mini class="wxdc-btn" @click.stop.prevent="onemore">再来一单</x-button>
                        </span>
